...
const FloorSvg = ({}) => {
  ...
  const F1Handler=()=>{
    ...
    const time=setTimeout(() => {
      dispatch(updateFloor(FirstFloor[0]));
      clearTimeout(time)
    }, 500);
  }
  ...
  const F2Handler=()=>{
    ...
    const time=setTimeout(() => {
      dispatch(updateFloor(FirstFloor[1]))
      clearTimeout(time)
    }, 500);
  }
  ...
  const F3Handler=()=>{
    ...
    const time=setTimeout(() => {
      dispatch(updateFloor(FirstFloor[2]))
      clearTimeout(time)
    }, 500);
  }
  ...
  const F4Handler=()=>{
    ...
    const time=setTimeout(() => {
      dispatch(updateFloor(FirstFloor[3]))
      clearTimeout(time)
    }, 500);
  }
  ...
  <g id="Layer_2" data-name="Layer 2">
    <g id="Layer_1-2" data-name="Layer 1">
      ...
      <circle onClick={()=>{!FirstFloor[0].sold===true && F1Handler()}}  class={`cls-4  ${FirstFloor[0]?.sold==true ? 'cursor-not-allowed' :'cursor-pointer'}`} cx="40.28" cy="116.15" r="14.08"  />
      <text  onClick={()=>{!FirstFloor[0].sold===true && F1Handler()}}  className={`cls-5 ${FirstFloor[0]?.sold==true ? 'cursor-not-allowed' :'cursor-pointer'}`} transform="translate(37.29 118.93)" >F1</text>
      
      <circle onClick={()=>{!FirstFloor[1].sold===true && F2Handler()}} class={`cls-4  ${FirstFloor[1]?.sold==true ? 'cursor-not-allowed' :'cursor-pointer'}`} cx="113.8" cy="116.15" r="14.08" />
      <text   onClick={()=>{!FirstFloor[1].sold===true && F2Handler()}} className={`cls-5 ${FirstFloor[1]?.sold==true ? 'cursor-not-allowed' :'cursor-pointer'}`} transform="translate(109.87 118.93)" >F2</text>
      
      <circle onClick={()=>{!FirstFloor[2].sold===true && F3Handler()}} class={`cls-4  ${FirstFloor[2]?.sold==true ? 'cursor-not-allowed' :'cursor-pointer'}`} cx="186.15" cy="116.15" r="14.08"   />
      <text   onClick={()=>{!FirstFloor[2].sold===true && F3Handler()}} className={`cls-5 ${FirstFloor[2]?.sold==true ? 'cursor-not-allowed' :'cursor-pointer'}`} transform="translate(182.17 118.93)" >F3</text>
      
      <circle onClick={()=>{!FirstFloor[3].sold===true && F4Handler()}} class={`cls-4  ${FirstFloor[3]?.sold==true ? 'cursor-not-allowed' :'cursor-pointer'}`} cx="264.37" cy="116.15" r="14.08"  />
      <text   onClick={()=>{!FirstFloor[3].sold===true && F4Handler()}} className={`cls-5 ${FirstFloor[3]?.sold==true ? 'cursor-not-allowed' :'cursor-pointer'}`} transform="translate(260.24 118.93)" >F4</text>
      <g id="Padlock">
