      ...
      {!menu &&
        ...
        <div className='flex flex-row relative w-[85%]  left-[13%] md:left-[3%] lg-small:left-[6%] lg:left-[8%]   top-[30%]  ' onMouseLeave={()=>{setFloor("")}} >
            ...
            <div className='relative  w-[50vw] md:w-[55.5vw] left-[22.5vw]  sm:[100vw]  md:left-[35%] lg-small:left-[28.5%] lg-pc:left-[29%] lg-tab: sm:left-[30%]    xl:left-[25%]  mb:left-[1%]  mb:w-[76vw] lg-tab:top-[3vh] lg-pc:top-[5vh] lg-tab:left-[34.5%] desktop-20:top-[0vh]  desktop-23:top-[5vh] desktop-23-h:top-[4vh] desktop-22:top-[5vh] desktop-22:left-[25%]  desktop-23:left-[25%] desktop-23-h:left-[26.5%] lg-pc:w-[60vw]       h-full '>                
                  <div className='flex flex-row items-center w-full h-full relative top-[30px] lg:top-[57px] mb:top-[3.7vh]   xl:top-[3rem] lg-tab:top-0 bg-red-500' onClick={()=>{floorHandler("2");}}>
                  ...
                  <div className='flex flex-row items-center w-full h-full relative top-[30px] lg:top-[57px] pc:top-[4vh] xl:top-[70px] mb:top-[4vh] desktop-20:top-[5vh] lg-tab:top-[3vh]  desktop-22:top-[5vh] desktop-23:top-[5vh] desktop-23-h:top-[5vh] bg-red-500 apple-7:top-[7.5vh] google-pix:top-[7.5vh]' onClick={()=>{floorHandler("1");}}>
                  ...
                  <div className='flex flex-row items-center w-full h-full relative top-[48px] lg-pc:top-[10vh] bg-red-500 lg-tab:top-[7vh] lg:top-[70px] xl:top-[110px] desktop-20:top-[10vh] desktop-22:top-[12vh] desktop-23:top-[7.5vh] desktop-23-h:top-[10vh] apple-7:top-[16vh] google-pix:top-[16vh]' onClick={()=>{floorHandler("mazen")}}>
                  ...
                  <div className='flex flex-row items-center w-full h-full relative top-[48px] lg-pc:top-[13vh] mb:top-[10vh] lg-tab:top-[9vh]  lg:top-[75px] xl:top-[120px] desktop-20:top-[10vh] desktop-22:top-[15vh] desktop-23:top-[8vh] desktop-23-h:top-[11vh] bg-red-500 apple-7:top-[18vh] google-pix:top-[18vh]' onClick={()=>{floorHandler("Basement")}}>
